...
class ApplicationController {
  ...
  updateAppIcon(iconKey) {
    try {
      ...
      // Icon mapping for available icons in public/assets/icons folder
      const iconPaths = {
        terminal: "public/assets/icons/terminal.png",
        activity: "public/assets/icons/activity.png",
        settings: "public/assets/icons/settings.png",
      };
    ...
    try {
      ...
      if (process.platform === "darwin") {
        ...
        if (app.dock) {
          ...
          setTimeout(() => {
            app.dock.setIcon(
              require("path").resolve(`public/assets/icons/${iconKey}.png`)
            );
          }, 50);
        }
      }
